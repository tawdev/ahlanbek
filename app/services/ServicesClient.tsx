        ...
        <>
            ...
            <section className="bg-slate-900 pt-48 pb-24 relative overflow-hidden">
                ...
                <div className="max-w-7xl 3xl:max-w-[1500px] 4xl:max-w-[1700px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
                    ...
                    <motion.p
                        ...
                        className="text-xl text-slate-400 max-w-2xl mx-auto leading-relaxed font-serif"
                    >
            ...
            <section className="py-24 bg-slate-900 text-white text-center relative overflow-hidden">
                ...
                <div className="relative z-10 max-w-4xl 3xl:max-w-[1200px] 4xl:max-w-[1400px] mx-auto px-4">
                    <h2 className="text-4xl md:text-5xl font-black mb-8 tracking-tight font-display">Ready to start your journey?</h2>
                    <p className="text-slate-400 text-lg mb-12 max-w-2xl mx-auto font-serif leading-relaxed">
                        Contact us today to discuss how we can help you achieve your goals with our professional services and experts.
                    </p>
                    <a
                        href="/contact"
                        className="inline-flex bg-primary hover:bg-amber-600 text-white font-black py-5 px-12 rounded-full transition-all hover:scale-105 shadow-2xl shadow-primary/20 uppercase tracking-widest text-sm font-ui"
                    >
                        Get a Quote
                    </a>
                </div>
