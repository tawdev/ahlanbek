                ...
                <div ref={marqueeRef} className="flex whitespace-nowrap border-y border-white/5 py-6">
                    <div className="flex animate-marquee marquee-item-1">
                        {[...values, ...values].map((value, i) => (
                            <span
                                key={i}
                                className="text-6xl md:text-8xl font-black text-transparent -webkit-text-stroke-1 stroke-white/20 px-8 flex items-center gap-4 hover:text-white hover:stroke-transparent transition-all duration-500 uppercase tracking-tighter font-display"
                            >
                                {value}
                ...
                <div ref={marqueeRefReverse} className="flex whitespace-nowrap border-b border-white/5 py-6 -mt-1">
                    <div className="flex animate-marquee-reverse marquee-item-2" style={{ transform: 'translateX(-50%)' }}>
                        {[...values, ...values].map((value, i) => (
                            <span
                                key={i}
                                className="text-6xl md:text-8xl font-black text-white px-8 flex items-center gap-4 hover:text-primary transition-all duration-500 uppercase tracking-tighter font-display"
                            >
                                {value}
